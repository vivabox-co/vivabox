// Inserts a new "actividades_extra" column into the "Experiencias" sheet,
// right after "claves_eleccion". Free text, pipe-separated like claves_eleccion:
// possible extra activities around the experience (beneficiary-facing, not
// wired into the code yet -- data capture only).
//
...
//   SHEET_ID=<spreadsheet id from the edit URL> node scripts/sheet-sync/add-actividades-extra.mjs
//
// Usage (applies the change):
//   SHEET_ID=<spreadsheet id> node scripts/sheet-sync/add-actividades-extra.mjs --confirm
//
...
const AFTER_HEADER = "claves_eleccion"
const NEW_HEADER = "actividades_extra"

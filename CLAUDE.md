...
| Writing or editing experience content (`descripcion_corta`/`shortDescription`, `nota_vivabox`/"La elegimos", `claves_eleccion`/"Claves de elección") | `docs/editorial/experiencias.md` |

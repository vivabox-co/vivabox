...
| 17 | formato | No | solo · duo · solo o duo | Alimenta el número de personas mostrado en la ficha/popup (`formatPeopleCount()` en `src/data/categories.ts`: solo → "1 persona", duo → "2 personas", solo o duo → "1-2 personas"). Usar "solo o duo" solo cuando la experiencia realmente acepta 1 o 2 personas indistintamente |
